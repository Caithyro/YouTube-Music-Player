...
struct PlaylistSnippet: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        thumbnails = try values.decodeIfPresent(PlaylistThumbnails.self,
                                                forKey: .thumbnails)
        ...
        resourceId = try values.decodeIfPresent(PlaylistResourceId.self,
                                                forKey: .resourceId)
        videoOwnerChannelTitle = try values.decodeIfPresent(String.self,
                                                            forKey: .videoOwnerChannelTitle)
        videoOwnerChannelId = try values.decodeIfPresent(String.self,
                                                         forKey: .videoOwnerChannelId)
    }
