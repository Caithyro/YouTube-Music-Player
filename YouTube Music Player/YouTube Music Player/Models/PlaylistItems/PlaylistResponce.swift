...
struct PlaylistResponce: Codable {
	...
	init(from decoder: Decoder) throws {
        ...
        playlistItems = try values.decodeIfPresent([PlaylistItems].self, forKey: .playlistItems)
        playlistPageInfo = try values.decodeIfPresent(PlaylistPageInfo.self, forKey: .playlistPageInfo)
	}
